...
type TProps = {
  ...
  right?: string | React.ReactNode; // Union type for the right prop
  left?: string | React.ReactNode; // Union type for the left prop
  iconColor?: string;
  loading?: boolean;
  //   disabled? : boolean
};
        ...
        >
          <View>
            {left && typeof left === 'string' ? (
              ...
              left // Render as React node if it's not a string
            )}
          </View>
          ...
          <View>
            {right && typeof right === 'string' ? (
              ...
              right // Render as React node if it's not a string
            )}
          </View>
        </View>
      )}
